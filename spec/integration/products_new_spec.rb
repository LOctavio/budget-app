...
RSpec.describe 'Products', type: :system do
  describe 'New' do
    ...
    it 'When I click the save button without filling in the name,
    the amount, and check the radio button
    I get a detailed error.' do
      click_button 'save'
      expect(page).to have_content('Your product was not created')
    end
    it 'When I click the save button after filling in the name, the amount,
    and check the radio button with correct data,
